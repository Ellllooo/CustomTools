...
3. **Get the Windows Installer or Zip File**

   Inside the latest release, find a Windows-specific file such as `.exe`, `.msi`, or `.zip`. Click to download it to your PC.

4. **Install or Extract Files**

   - If you downloaded an `.exe` or `.msi` file, double-click it to start the installation. Follow the on-screen steps.
   - If you downloaded a `.zip` file, right-click on it and select "Extract All." Choose a folder where you want the program to stay.
...
7. **Run CustomTools**
   ...
   This will start CustomTools and show the main menu.

---

## 📂 How To Use CustomTools
...
3. Repeat the installation or extraction steps.
